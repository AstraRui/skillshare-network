...
class User(Base):
    ...
    wanted_skills = relationship(
        "UserSkillsWanted", back_populates="user", cascade="all, delete-orphan"
    )
    initiated_exchanges = relationship(
        "Exchange", foreign_keys="Exchange.initiator_id", back_populates="initiator"
    )
