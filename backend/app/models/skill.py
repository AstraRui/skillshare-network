...
class SkillCategory(Base):
    ...
    parent_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("skill_categories.id", ondelete="SET NULL"), index=True)
...
class Skill(Base):
    ...
    category_id: Mapped[int] = mapped_column(Integer, ForeignKey("skill_categories.id", ondelete="RESTRICT"), nullable=False, index=True)
