...
from app.seed.test_data.generators import generate_review_comment


EXCHANGES_DATA = [
    {"listing": 0, "initiator": 0, "partner": 1, "status": ExchangeStatus.active, "initiator_gives": "Python", "initiator_gets": "Figma", "partner_gives": "Figma", "partner_gets": "Python"},
    {"listing": 1, "initiator": 1, "partner": 3, "status": ExchangeStatus.discussion, "initiator_gives": "Figma", "initiator_gets": "Английский язык", "partner_gives": "Английский язык", "partner_gets": "Figma"},
    {"listing": 2, "initiator": 2, "partner": 7, "status": ExchangeStatus.completed, "initiator_gives": "SQL", "initiator_gets": "Видеомонтаж", "partner_gives": "Видеомонтаж", "partner_gets": "SQL"},
    {"listing": 3, "initiator": 3, "partner": 0, "status": ExchangeStatus.completed, "initiator_gives": "Английский язык", "initiator_gets": "HTML/CSS", "partner_gives": "HTML/CSS", "partner_gets": "Английский язык"},
    {"listing": 4, "initiator": 4, "partner": 17, "status": ExchangeStatus.active, "initiator_gives": "SMM", "initiator_gets": "Фотография", "partner_gives": "Фотография", "partner_gets": "SMM"},
    {"listing": 6, "initiator": 6, "partner": 16, "status": ExchangeStatus.cancelled, "initiator_gives": "Электрика", "initiator_gets": "Немецкий язык", "partner_gives": "Немецкий язык", "partner_gets": "Электрика"},
    {"listing": 7, "initiator": 7, "partner": 14, "status": ExchangeStatus.active, "initiator_gives": "Видеомонтаж", "initiator_gets": "FastAPI", "partner_gives": "FastAPI", "partner_gets": "Видеомонтаж"},
    {"listing": 9, "initiator": 9, "partner": 10, "status": ExchangeStatus.completed, "initiator_gives": "SMM", "initiator_gets": "Фотография", "partner_gives": "Фотография", "partner_gets": "SMM"},
]
